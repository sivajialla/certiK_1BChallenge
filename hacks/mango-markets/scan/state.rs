...
#[derive(Copy, Clone)]
#[repr(packed)]
// --- Trimmed here: dropped OrderBookStateHeader, AdvancedOrderType/TriggerCondition,
// AnyAdvancedOrder, PerpTriggerOrder, AdvancedOrders, ReferrerMemory, ReferrerIdRecord,
// TokenAccount - all unrelated to the health/oracle/withdraw exploit path (trigger orders,
// referrer program, token-account caching) ---
